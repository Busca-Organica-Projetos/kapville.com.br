        ...
        <div class="container">
            ...
            <section class="padding-v-10">
                <div class="container">
                    ...
                    <ol>
                        <li>
                            adicionar <kbd>'jquery.buscaorganica.ambedFacebook'</kbd> no <strong>$borg->js_custom</strong> ANTES do _footer.php;
                            <br>
                            <i>Obs.: Este script já está como default no _configuracoes caso não for utilizar no footer ou algo genérico, retirar e colocar na página específica</i>
                        </li>
                        <li>
