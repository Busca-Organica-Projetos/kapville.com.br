    ...
    <div class="container">
        <div class="flexBetween">
            ...
            <ul class="gap-5 jus-right social-top">
                <li><a data-click-track="Facebook - Barra do Topo" href="<?php echo $facebook; ?>" title="Facebook" target="_blank"><i class="fa-brands fa-facebook"></i></a></li>
                <li><a data-click-track="Instagram - Barra do Topo" href="<?php echo $instagram; ?>" title="Instagram" target="_blank"><i class="fa-brands fa-instagram"></i></a></li>
